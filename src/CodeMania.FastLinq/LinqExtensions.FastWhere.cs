...
namespace CodeMania.FastLinq
{
    public static partial class LinqExtensions
    {
        ...
        {
            return WhereEnumerable<T>.From(CheckSource(source).GetEnumerator(), predicate);
        }
        ...
        public static WhereEnumerable<T, ArrayEnumerable<T>.Enumerator> FastWhere<T>(
            ...
            Func<T, bool> predicate)
        {
            return WhereEnumerable<T>.From(new ArrayEnumerable<T>(CheckSource(source)).GetEnumerator(), predicate);
        }
        ...
        {
            return WhereEnumerable<KeyValuePair<TKey, TValue>>.From(CheckSource(source).GetEnumerator(), predicate);
        }
        ...
        {
            return WhereIndexedEnumerable<T>.From(CheckSource(source).GetEnumerator(), predicate);
        }
        ...
        public static WhereIndexedEnumerable<T, ArrayEnumerable<T>.Enumerator> FastWhere<T>(
            ...
            Func<T, int, bool> predicate)
        {
            return WhereIndexedEnumerable<T>.From(new ArrayEnumerable<T>( CheckSource(source)).GetEnumerator(), predicate);
        }
        ...
        {
            return WhereIndexedEnumerable<KeyValuePair<TKey, TValue>>.From(CheckSource(source).GetEnumerator(), predicate);
        }
